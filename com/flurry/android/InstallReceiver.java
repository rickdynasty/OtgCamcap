...
public final class InstallReceiver extends BroadcastReceiver {
    ...
    public final void onReceive(Context context, Intent intent) {
        this.b = context.getFileStreamPath(".flurryinstallreceiver." + Integer.toString(v.c().hashCode(), 16));
        if (v.a()) {
        ...
        if (stringExtra != null && "com.android.vending.INSTALL_REFERRER".equals(intent.getAction())) {
            try {
                ...
                am.c("InstallReceiver", "Invalid referrer Tag: " + e.getMessage());
            }
        }
    }
    ...
    private static Map a(String str) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (split2.length != 2) {
                am.a("InstallReceiver", "Invalid referrer Element: " + split[i] + " in referrer tag " + str);
            } else {
